...
Google Sans Flex Variable is bundled locally and used for every role. Large headlines stay regular-weight and tightly tracked. Medium weight is reserved for track names, labels, facts, controls, and links. Body copy uses open line height and readable measures.
...
Photography is documentary and full-bleed within a structured mosaic. Captions use a dark image-edge fade, and every image carries descriptive alt text.
